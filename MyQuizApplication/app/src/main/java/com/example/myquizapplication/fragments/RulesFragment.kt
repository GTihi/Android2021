...
class RulesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rootView = inflater.inflate(R.layout.fragment_rules, container, false)
        backButton = rootView.findViewById(R.id.backButton)

        //if we press the back button -> we will go back to the main page
        backButton.setOnClickListener(View.OnClickListener {
            val newFragment = MainFragment()
            val fragmentManager = fragmentManager
            val transaction = fragmentManager!!.beginTransaction()
            transaction.replace(R.id.rulesFragment, newFragment)
